...
# Scan your code with SonarQube [![QA Main](https://github.com/step-security/sonarqube-scan-action/actions/workflows/qa-main.yml/badge.svg)](https://github.com/step-security/sonarqube-scan-action/actions/workflows/qa-main.yml) [![QA Install Build Wrapper](https://github.com/step-security/sonarqube-scan-action/actions/workflows/qa-install-build-wrapper.yml/badge.svg)](https://github.com/step-security/sonarqube-scan-action/actions/workflows/qa-install-build-wrapper.yml) [![QA Scripts](https://github.com/step-security/sonarqube-scan-action/actions/workflows/qa-scripts.yml/badge.svg)](https://github.com/step-security/sonarqube-scan-action/actions/workflows/qa-scripts.yml) [![QA Deprecated C and C++ Action](https://github.com/step-security/sonarqube-scan-action/actions/workflows/qa-deprecated-c-cpp.yml/badge.svg)](https://github.com/step-security/sonarqube-scan-action/actions/workflows/qa-deprecated-c-cpp.yml)
  ...
  sonarqube:
    ...
    - uses: actions/checkout@v6
      with:
        ...
        fetch-depth: 0
    - name: SonarQube Scan
      uses: step-security/sonarqube-scan-action@v8
      env:
...
jobs:
  sonarqube:
    ...
    - name: Install Build Wrapper
      uses: step-security/sonarqube-scan-action/install-build-wrapper@v4
